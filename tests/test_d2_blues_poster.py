...
def test_blues_poster_is_deterministic_and_layered(tmp_path: Path):
    ...
    for group_id in (
        "d2-random-polygons", "d2-settling-mist", "d2-coffin-gravity", "d2-afterimages",
        "d2-burial-backdrop", "d2-density-bodies", "d2-internal-organs",
        "d2-left-internal-organs", "d2-right-internal-organs", "d2-left-tendons",
        "d2-right-tendons", "d2-call-response", "d2-contact-seam", "d2-contact-flows",
        "d2-counterflow", "d2-blue-note", "d2-aftertone-memory", "d2-burial-foreground",
    ...
    assert metadata["renderer"]["version"] == "1.5"
    ...
    assert metadata["visual_contract"]["structural_layers"] == ["coffin_gravity", "afterimages_aab", "internal_organs", "tendons", "call_response", "aligned_contact_seam", "contact_flows", "counterflow", "blue_note", "aftertone_memory"]
